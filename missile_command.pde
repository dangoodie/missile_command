...
PImage line, separator, pause, crosshair, destination, background, menuBackground, gameOverBackground;
PImage enemy_explosion, antimissile_explosion, city, destroyed_city, base, destroyedBase;
